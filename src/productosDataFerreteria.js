...
const TornillosList = [
    ...
    {
        id: 20,
        title: "Tornillos de Cabeza Pentagonal",
        description: "Crea una unión a prueba de manipulaciones con una cabeza que solo se puede quitar con una llave de 5 puntos",
        products: 15,
        image: "https://via.placeholder.com/80"
    },
    {
    ...
    {
        id: 22,
        title: "Tornillos de Empuje",
        description: "Asegura cables y paneles de computadora",
        products: 24,
        image: "https://via.placeholder.com/80"
    },
    {
        id: 23,
        title: "Abrazaderas para Madera",
        description: "Crea uniones seguras entre tablas, bloques de carnicero y encimeras",
        products: 3,
        image: "https://via.placeholder.com/80"
    },
    {
        id: 24,
        title: "Barriles y Tornillos de Unión",
        description: "Enrosca juntos para un sujetador de perfil bajo",
        products: 884,
        image: "https://via.placeholder.com/80"
    },
    {
        ...
        description: "Ancla, conecta o cuelga componentes en una amplia variedad de aplicaciones",
        products: 5337,
        image: "https://via.placeholder.com/80"
    },
    {
        id: 26,
        title: "Adaptadores de Rosca",
        description: "Une roscas de diferente tipo, tamaño y género",
        products: 3607,
        image: "https://via.placeholder.com/80"
    },
    {
        id: 27,
        title: "Separadores",
        description: "Rosca para separar o conectar piezas, así como para posicionar componentes en ensamblajes",
        products: 1594,
        image: "https://via.placeholder.com/80"
    },
    {
        id: 28,
        title: "Émbolos de Resorte",
        description: "Aplica presión precisa y constante para posicionar, indexar y expulsar piezas",
        products: 1034,
        image: "https://via.placeholder.com/80"
    },
    {
        id: 29,
        title: "Tapas para Separadores",
        description: "Crea un acabado en los separadores y protégelos del polvo y los residuos",
        products: 66,
        image: "https://via.placeholder.com/80"
    },
    {
        id: 30,
        title: "Espárragos de Un Solo Extremo",
        description: "Usa el extremo sin rosca como punto de pivote, bisagra, eje o pasador de ubicación",
        products: 184,
        image: "https://via.placeholder.com/80"
    },
    {
        id: 31,
        title: "Anclajes",
        description: "Asegura uniones estructurales en concreto, ladrillo y otros materiales de construcción",
        products: 938,
        image: "https://via.placeholder.com/80"
    },
    {
        id: 32,
        title: "Tuercas de Remache",
        description: "Añade roscas a paneles delgados con acceso desde un solo lado; también conocido como insertos ciegos",
        products: 464,
        image: "https://via.placeholder.com/80"
    },
    {
        id: 33,
        title: "Tuercas de Soldadura",
        description: "Suelda a superficies de metal para añadir roscas permanentes",
        products: 534,
        image: "https://via.placeholder.com/80"
    },
    {
        id: 34,
        title: "Pasadores de Retención",
        description: "Presiona en agujeros en materiales delgados como paneles y placas de circuito para unir o alinear permanentemente",
        products: 84,
        image: "https://via.placeholder.com/80"
    },
    {
        id: 35,
        title: "Clavos",
        description: "Clava en madera, plástico, paneles de yeso y mampostería",
        products: 22,
        image: "https://via.placeholder.com/80"
    },
    {
        id: 36,
        title: "Anclajes de Palanca",
        description: "Reemplaza tu anclaje de palanca si se cae al remover el tornillo de palanca",
        products: 5,
        image: "https://via.placeholder.com/80"
    },
    {
        id: 37,
        title: "Remaches",
        description: "Une materiales de forma permanente, especialmente cuando son muy delgados o frágiles para sujetar con tornillos",
        products: 6,
        image: "https://via.placeholder.com/80"
    },
    {
        id: 38,
        title: "Clavos con Rosca",
        description: "Clava como clavos pero sujeta como tornillos en agujeros perforados en madera, plástico, paneles de yeso y mampostería",
        products: 76,
        image: "https://via.placeholder.com/80"
    },
    {
        ...
        description: "Aplica sobre las cabezas de los sujetadores para evitar que los destornilladores, llaves y alicates se deslicen",
        products: 1,
        image: "https://via.placeholder.com/80"
    }
