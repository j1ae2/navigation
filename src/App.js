...
import {
  ...
  Soldaduras,
  Tuverias,
} from "./modules/Ferreteria/tipoFerreteria";
    ...
    <header className="header">
      ...
      <nav className="main-nav">
        <ul>
          ...
          <li>
            <Link to="/Ferreteria">Ferretería</Link>
          </li>
          <li>
          ...
          <li>
            <Link to="/returns-warranty">Devoluciones & Garantías</Link>
          </li>
          <li>
    ...
    <Router>
      <div className="App">
        ...
        <Routes>
          ...
          <Route
            path="/Ferreteria/Tornillos/:productTitle"
            element={<Tornillos />}
          />
          <Route path="/Ferreteria/Adhesivos" element={<Adhesivos />} />
          <Route
            path="/Ferreteria/Adhesivos/:productTitle"
            element={<Adhesivos />}
          />
